...
namespace SecureMedicalRecordSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260527124627_AddPasswordResetTokensTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.AnalysisReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("GeneratedByDoctorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TigrisObjectKey")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("GeneratedByDoctorId");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.ChatConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RelatedHealthRecordId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RelatedHealthRecordId");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.CommonLabUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ImprovingDirection")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.Property<decimal?>("NormalRangeHigh")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("NormalRangeLow")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("NormalRangeUnit")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.MasterMedication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PrimaryMarkers")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SecondaryMarkers")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.MedicalRecord", b =>
                {
                    ...
                    b.HasIndex("AssignedDoctorId", "CreatedAt", "State");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.PatientVitalBaseline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double?>("AvgBmi")
                        .HasColumnType("float");

                    b.Property<double?>("AvgDiastolic")
                        .HasColumnType("float");

                    b.Property<double?>("AvgHeartRate")
                        .HasColumnType("float");

                    b.Property<double?>("AvgSpo2")
                        .HasColumnType("float");

                    b.Property<double?>("AvgSystolic")
                        .HasColumnType("float");
                    ...
                    b.Property<int>("RecordsUsedForBaseline")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientVitalBaselines");
                });

            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.Prescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PatientHealthRecordId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PatientHealthRecordId");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.ScanHistory", b =>
                {
                    ...
                    b.HasIndex("DoctorId", "ScannedAt");

                    b.ToTable("ScanHistories");
                });

            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.StabilityAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.ChatMessage", b =>
                {
                    b.HasOne("SecureMedicalRecordSystem.Core.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SecureMedicalRecordSystem.Core.Entities.MedicalRecord", "RelatedHealthRecord")
                        .WithMany()
                        .HasForeignKey("RelatedHealthRecordId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SecureMedicalRecordSystem.Core.Entities.ApplicationUser", "Sender")
                        .WithMany()
                    ...
                    b.Navigation("RelatedHealthRecord");
            ...
            modelBuilder.Entity("SecureMedicalRecordSystem.Core.Entities.Prescription", b =>
                {
                    b.HasOne("SecureMedicalRecordSystem.Core.Entities.PatientHealthRecord", "PatientHealthRecord")
                        .WithMany("Prescriptions")
                        .HasForeignKey("PatientHealthRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PatientHealthRecord");
                });
